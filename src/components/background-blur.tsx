export function BackgroundBlur() {
	return (
		...
		>
			...
			>
				<path
					d="M27.0999 584.678C-35.5299 563.755 -61.9517 430.039 -67.3339 365.796L-114.308 299.154C-117.674 238.861 -100.553 102.69 -5.14706 40.4511C90.259 -21.9877 151.136 3.343 169.648 23.8007L294.84 221.003C311.674 241.62 368.724 305.355 462.243 395.357C555.763 485.358 313.929 564.867 181.323 593.372C156.011 599.192 89.7297 605.602 27.0999 584.678Z"
					fill="#B892FF"
				/>
			</svg>
